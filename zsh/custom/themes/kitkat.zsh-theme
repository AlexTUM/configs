...
# Modify Git prompt
ZSH_THEME_GIT_PROMPT_PREFIX=" ${CAT_LAVENDER}on ${CAT_GREEN}"
ZSH_THEME_GIT_PROMPT_SUFFIX="%{$reset_color%}"
ZSH_THEME_GIT_PROMPT_DIRTY="${CAT_RED}⋯"
ZSH_THEME_GIT_PROMPT_CLEAN="${CAT_GREEN}."

ZSH_THEME_GIT_PROMPT_ADDED="${CAT_SKY}+"
ZSH_THEME_GIT_PROMPT_MODIFIED="${CAT_SKY}m"
ZSH_THEME_GIT_PROMPT_DELETED="${CAT_SKY}-"
ZSH_THEME_GIT_PROMPT_RENAMED="${CAT_SKY}r"
ZSH_THEME_GIT_PROMPT_UNMERGED="${CAT_SKY}*"
ZSH_THEME_GIT_PROMPT_UNTRACKED="${CAT_SKY}u"
...
${CAT_ACCENT}${PR_ULCORNER}${PR_HBAR}${CAT_LAVENDER}(\
${CAT_MAROON}%${PR_PWDLEN}<...<%~%<<\
${CAT_LAVENDER})$(virtualenv_prompt_info)$(ruby_prompt_info)${CAT_ACCENT}${PR_HBAR}${PR_HBAR}${(e)PR_FILLBAR}\
${CAT_LAVENDER}<${CAT_BLUE}%!${CAT_LAVENDER}>${CAT_ACCENT}${PR_HBAR}${PR_HBAR}${PR_HBAR}${PR_HBAR}${CAT_LAVENDER}(\
${CAT_ROSEWATER}%(!.%SROOT%s.%n)${CAT_LAVENDER}@${CAT_ROSEWATER}%m:%l\
${CAT_LAVENDER})${CAT_ACCENT}${PR_HBAR}${PR_URCORNER}\

${CAT_ACCENT}${PR_LLCORNER}${PR_HBAR}${CAT_LAVENDER}(\
${CAT_ROSEWATER}%D{%H:%M:%S}\
$(git_prompt_info) $(git_prompt_status)${CAT_LAVENDER})${CAT_ACCENT}${PR_HBAR}\
${PR_HBAR}\
>${PR_NO_COLOUR} '
...
${CAT_LAVENDER}(${CAT_ROSEWATER}%D{%a,%b%d}${CAT_LAVENDER})${CAT_ACCENT}${PR_HBAR}${PR_LRCORNER}${PR_NO_COLOUR}'
